...
const ClassCard = ({ card }) => {
  ...
  const handleAddCart = (card) => {
    ...
    if (user && user.email) {
      const cartItem={courseId:card._id,courseName,image,seats,price,email:user?.email}
      fetch("http://localhost:5000/carts", {
        ...
        .then((data) => {
          ...
          if (data.insertedId) {
            Swal.fire("Good job!", "Cart added in database!", "success");
          }
        });
    }
    else {
  ...
  <>
  {
    seats ==0?  <div className="mt-12 mx-auto ">
    <div className="card w-96  h-[70vh] shadow-xl bg-red-400">
      ...
      <div className="card-body ">
        ...
        {isVerify == "admin" || isVerify=="instructors" || seats==0 ? (
          <button
  ...
  </div>:  <div className="mt-12 mx-auto">
